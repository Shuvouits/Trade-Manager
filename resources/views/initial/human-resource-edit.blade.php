                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 offset-md-2">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="/initial/human-resource-update" method="post">
                                        {{@csrf_field()}}
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="birth_date" class="form-control daterange-single" value="{{$birth_date}}" required>
                                                        @error('birth_date')
                                                        <span style="color:red; font-weight:bold; font-family:josefin-sans">{{ $message }}</span>
                                                        @enderror
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9">
                                                    <input type="text" name="parent_name" class="form-control" value="{{$parent_name}}" required>
                                                    @error('parent_name')
                                                    <span style="color:red; font-weight:bold; font-family:josefin-sans">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="joining_date" value="{{$joining_date}}" class="form-control daterange-single" required>
                                                        @error('joining_date')
                                                        <span style="color:red; font-weight:bold; font-family:josefin-sans">{{ $message }}</span>
                                                        @enderror
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9">
                                                    <textarea rows="3" cols="3" name="permanent_address" class="form-control" required>{{$permanent_address}}</textarea>
                                                </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9">
                                                    <textarea rows="3" cols="3" name="contact_address" class="form-control" placeholder="Enter your message here" required>{{$contact_address}}</textarea>
                                                </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9">
                                                    <input type="number" name="contact_number" class="form-control" value="{{$contact_number}}" required>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9">
                                                    <textarea rows="3" cols="3" name="qualification" class="form-control" placeholder="Enter your message here" required>{{$qualification}}</textarea>
                                                </div>
                                                @error('qualification')
                                                <span style="color:red; font-weight:bold; font-family:josefin-sans">{{ $message }}</span>
                                                @enderror
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9">
                                                    <select class="form-control select" id="joining_point" name="joining_point" data-fouc required>
                                                        ...
                                                        <option value="{{$item->id}}" @if($item->id == $joining_point) selected @endif>{{$item->department}}</option>
                                                        @endforeach
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9">
                                                    <select class="form-control select" id="position" name="position" data-fouc required>
                                                        <option value="{{$position}}" selected>{{$position_name}}</option>

                    ...
                    <div class="breadcrumb-line breadcrumb-line-dark header-elements-lg-inline">
                        <div class="d-flex">
                            <div class="breadcrumb">
                                ...
                                <span class="breadcrumb-item active">Payroll Addings</span>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 offset-md-2">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="/initial/payroll-breakup-add-post" method="post">
                                        {{@csrf_field()}}
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="form-group row">
                                                <label class="col-lg-3 col-form-label">Over Time Rate/Hour</label>
                                                <div class="col-lg-9">
                                                    <input type="number" step="any" name="over_time" class="form-control" placeholder="Enter Over Time" required>
                                                    @error('over_time')
                                                    <span style="color:red; font-weight:bold; font-family:josefin-sans">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="form-group row">
                                                <label class="col-lg-3 col-form-label">Incentive Bonus Limit</label>
                                                <div class="col-lg-9">
                                                    <input type="number" step="any" name="incentive_bonus" class="form-control" placeholder="Enter Incentive Bonus Limit" required>
                                                    @error('incentive_bonus')
                                                    <span style="color:red; font-weight:bold; font-family:josefin-sans">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9">
                                                    <input type="number" step="any" name="transport" class="form-control" placeholder="Enter Transport Bill" required>
                                                    @error('transport')
                                                    <span style="color:red; font-weight:bold; font-family:josefin-sans">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9">
                                                    <input type="number" step="any" name="mobile_bill" class="form-control" placeholder="Enter Mobile Bill" required>
                                                    @error('mobile_bill')
                                                    <span style="color:red; font-weight:bold; font-family:josefin-sans">{{ $message }}</span>
                                                    @enderror
                                                </div>

                    ...
                    <div class="breadcrumb-line breadcrumb-line-dark header-elements-lg-inline">
                        <div class="d-flex">
                            <div class="breadcrumb">
                                ...
                                <span class="breadcrumb-item active">Department & Position Add</span>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 offset-md-2">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="/initial/department-position/add" method="post">
                                        {{@csrf_field()}}
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="form-group row">
                                                <label class="col-lg-3 col-form-label">Name of The Department </label>
                                                <div class="col-lg-9">

                                                    <input type="text" name="department_name" class="form-control" placeholder="Enter your Department" required>

...
<body>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <fieldset>
                                        <legend class="font-weight-semibold">Coffee / Total Income (Current Month)</legend>
                                        ...
                                        <table class="table table-hover table-striped">
                                            ...
                                            <tbody>
                                                @foreach($current_month_income as $key=>$item)
                                                <tr>
                                                    <td>{{$key+1}}</td>
                                                    <td>{{$item->name}}</td>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <fieldset>
                                        <legend class="font-weight-semibold">Coffee / Total Expenses (Current Month)</legend>
    ...
    <!---View modal---->
    @foreach($current_month_history as $key=>$item)

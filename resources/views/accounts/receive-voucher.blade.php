                    ...
                    <div class="breadcrumb-line breadcrumb-line-dark header-elements-lg-inline">
                        <div class="d-flex">
                            <div class="breadcrumb">
                                ...
                                <span class="breadcrumb-item active">Receive Voucher</span>
                            </div>
                        ...
                        <div class="col-md-8 offset-md-2">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="/accounts/receive-voucher-post" method="post">
                                        {{@csrf_field()}}
                                        ...
                                        <fieldset>
                                            <legend class="font-weight-semibold">Accounts / Receive-Voucher</legend>
                                            ...
                                            <div id="cash" style="display:none">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9">
                                                        <div class="form-group">
                                                            <input type="number" step="any" class="form-control" name="amount_cash" placeholder="Enter the Cash Amount">
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div id="bank" style="display:none">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9">
                                                        <div class="form-group">
                                                            <input type="number" step="any" class="form-control" name="amount_bank" placeholder="Enter the Bank Amount">
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div id="dues" style="display: none;">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9">
                                                        <div class="form-group">
                                                            <input type="number" step="any" class="form-control" name="amount_dues" placeholder="Enter Total Dues Amount">
                                                        </div>
                                                    </div>
                                                </div>
        ...
        $('#account_id').on('change', function() {
            ...
            $.ajax({
                ...
                success: function(result) {
                    ...
                    //$('#sub_account_id').html('<div class="form-group row"><label class="col-lg-3 col-form-label">Sub-Account-ID</label><div class="col-md-9"><div class="form-group"> <select class="form-control select-search" name="sub_account_id" id="sub_account_id_data"><option selected disabled value="">--select--</option></select></div></div></div>');

                    ...
                    <div class="breadcrumb-line breadcrumb-line-dark header-elements-lg-inline">
                        <div class="d-flex">
                            <div class="breadcrumb">
                                ...
                                <span class="breadcrumb-item active">Opening Balance</span>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 offset-md-2">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="/accounts/opening-balance" method="post">
                                        {{@csrf_field()}}


                                        <fieldset>
                                            <legend class="font-weight-semibold">Accounts / Opening Balance</legend>
                                            ...
                                            <div class="form-group row bank" style="display: none;">
                                                <label class="col-lg-3 col-form-label">Bank ID</label>
                                                <div class="col-lg-9">
                                                    <div class="form-group">

                                                        <select class="form-control select-search" name="bank_id">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <table class="table  datatable-basic table-striped table-hover">
                        ...
                        <tbody>
                            @foreach($opening_balance as $count=>$item)
                            <tr>
                                <td>{{$count+1}}</td>
                                <td>{{$item->date}}</td>
                                <td>
                                    ...
                                    <span class="ml-1">
                                       @foreach($bank as $data)
                                         @if($data->id == $item->bank_id)
                                         <span class="badge badge-danger">{{$data->bank_name}}</span>
                                         @endif
                                       @endforeach
                                    </span>
                                </td>
                                    ...
                                    <div class="list-icons">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                ...
                                                <a href="/accounts/opening-balance/{{$item->id}}" class="dropdown-item"><i class="icon-trash"></i>Delete</a>

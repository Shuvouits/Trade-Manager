                    ...
                    <div class="breadcrumb-line breadcrumb-line-dark header-elements-lg-inline">
                        <div class="d-flex">
                            <div class="breadcrumb">
                                ...
                                <span class="breadcrumb-item active">Payroll Sheet / Till Date</span>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 offset-md-2">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="/view-print/payroll-sheet-till-date" method="post">
                                        {{@csrf_field()}}


                                        <fieldset>
                                            <legend class="font-weight-semibold">Payroll Sheet  | Till Date

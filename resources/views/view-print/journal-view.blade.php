...
<head>
    ...
    <title>XPERT DIGITAL AGENCY | Journal View</title>
    @include('link')
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-header" style="font-size: 11px;">
                                    ...
                                    <p class="text-center" style="font-weight:bold">JOURNAL</p>
                                    <p class="">From Date : <span style="font-size: 12px;">{{ date('d-M-Y', strtotime($date_start)) }}</span>
                                    </p>
                                    <p class="">To Date : <span style="font-size: 12px;">{{ date('d-M-Y', strtotime($date_finished)) }}</span>
                                    </p>
                                    <hr>
                                ...
                                <div class="card-body" style="font-size: 11px;">
                                    ...
                                    <table class="table datatable-button-html5-basic  table-striped table-hover" >
                                        <thead>
                                            <th>Date</th>
                                            <th>Ref</th>
                                            <th>Particulars</th>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="credit">
                                                        ...
                                                        @if ($data->voucher_id == $item->id)
                                                        @if ($data->account_id == $item->account_id && $data->account_id != '')
                                                        <p style="font-weight:bold">{{ $item->account_name }}</p>
                                                        @endif

                                                        @if ($data->transaction_mode == $item->transaction_mode && $data->transaction_mode != '')
                                                        <p style="font-weight:bold">{{ $item->transaction_mode_name }}</p>
                                                        @endif

                                                        @if ($data->additional_account == $item->additional_account && $data->additional_account != '')
                                                        <p style="font-weight:bold">{{ $item->additional_account_name }}</p>
                                                        @endif
                                                        @endif
                                                        @endforeach
                                                ...
                                                <td class="related-account">
                                                    <div class="debit">
                                                        ...
                                                        <p style="margin-bottom: 20px">{{ $item->sub_account_name }}</p>
                                                        @endif

                                                        @if ($data->bank_id == $item->bank_id && $item->bank_id != '')
                                                        <p style="margin-bottom: 20px">{{ $item->bank_name }}</p>
                                                        @endif
                                                        @endif
                                                        @endforeach
                                                    ...
                                                    <div class="credit">
                                                        ...
                                                        <p style="margin-top:12px; font-weight:bold">{{ $item->sub_account_name }}</p>
                                                        @endif

                                                        @if ($data->bank_id == $item->bank_id && $item->bank_id != '')
                                                        <p style="margin-top:12px; font-weight:bold ">{{ $item->bank_name }}</p>
                                                        @endif
                                                        @endif
                                                        @endforeach
                                                ...
                                                <td>
                                                    @foreach ($voucher_debit as $data)
                                                    @if ($data->voucher_id == $item->id)
                                                    <p style="margin-bottom: 20px">{{ $data->amount }}</p>
                                                    @endif
                                                    @endforeach
                                                </td>
                                                ...
                                                <td>
                                                    @foreach ($voucher_credit as $data)
                                                    @if ($data->voucher_id == $item->id)
                                                    <p style="margin-top:40px; font-weight:bold">{{ $data->amount }}</p>
                                                    @endif
                                                    @endforeach
                                                </td>
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="card">
                                                                ...
                                                                <div class="card-body">
                                                                    ...
                                                                    <form action="/view-print/accounts/journal/delete" method="post">
                                                                        {{ @csrf_field() }}
                                                                        ...
                                                                        <fieldset>
                                                                            ...
                                                                            <div class="form-group row">
                                                                                <label class="col-lg-3 col-form-label">Company
                                                                                    Name</label>
                                                                                <div class="col-lg-9">
                                                                            ...
                                                                            <div class="form-group row">
                                                                                <label class="col-lg-3 col-form-label">Admin
                                                                                    Password</label>
                                                                                <div class="col-lg-9">

                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 offset-md-2">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="/view-print/ledger-patron-post" method="post">
                                        {{@csrf_field()}}


                                        <fieldset>
                                            <legend class="font-weight-semibold">View Print / Ledger-Patron
                                                <div class="text-right">
                                                    <a href="/view-print/ledger" class="btn btn-light sr-only"><i class="icon-comment-discussion mr-1"></i>Expense/Asset</a>
                                                    <a href="/view-print/ledger-income" class="btn btn-light sr-only"><i class="icon-comment-discussion mr-1"></i>Income/Liablities</a>

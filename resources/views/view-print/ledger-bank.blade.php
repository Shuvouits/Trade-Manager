                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 offset-md-2">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="/view-print/ledger-bank-post" method="post">
                                        {{@csrf_field()}}


                                        <fieldset>
                                            <legend class="font-weight-semibold">View Print / Ledger-Bank
                                                <div class="text-right">
                                                    
                                                    <a href="/view-print/ledger-patron" class="btn btn-light"><i class="icon-comment-discussion mr-2"></i>Patron</a>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9">
                                                    <select class="form-control select-search"  name="bank_id" data-fouc required>

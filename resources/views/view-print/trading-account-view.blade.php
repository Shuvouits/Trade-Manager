...
<head>
    ...
    <title>Xpert SEO | Trading Account</title>
    @include('link')
                    ...
                    <div class="breadcrumb-line breadcrumb-line-dark header-elements-lg-inline">
                        <div class="d-flex">
                            <div class="breadcrumb">
                                ...
                                <span class="breadcrumb-item active">Trading Account</span>
                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <table class="table table-striped table-bordered table-hover" style="font-size: 12px;">
                                                <thead>
                                                    <tr>
                                                        <th colspan="2" class="text-center">DR</th>


                                                        <th colspan="2" class="text-center">CR</th>
                                                    </tr>
                                                    <tr>
                                                        <th>Particular</th>
                                                        <th>Amount</th>
                                                ...
                                                <tbody>
                                                    @foreach($trading_account_all_data as $item)
                                                    <tr>
                                                        <td>
                                                            @if($item->dr > 0)
                                                            {{$item->account_name}}
                                                    ...
                                                    <tr>
                                                        <td style="font-weight: bold; color:green">Gross Profit & Sales</td>
                                                        <td>{{ $trading_account_credit_sum - $trading_account_debit_sum}}</td>
                                                        <td></td>
                                                        <td></td>
                                                    ...
                                                    <tr style="font-weight: bold;">
                                                        <td></td>
                                                        <td>{{ ($trading_account_credit_sum - $trading_account_debit_sum) + $trading_account_debit_sum }} </td>
                                                        <td></td>
                                                        <td>{{$trading_account_credit_sum}}</td>
                                                    </tr>

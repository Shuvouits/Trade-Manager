                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 offset-md-2">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="/view-print/journal-specific-post" method="post">
                                        {{@csrf_field()}}


                                        <fieldset>
                                            <legend class="font-weight-semibold">View Print / Journal-Specific Patron
                                                ...
                                                <div class="col-lg-9">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control select-search" name="patron_id" data-fouc required>
                                                            <option value="" selected disabled>--Select Patron--</option>

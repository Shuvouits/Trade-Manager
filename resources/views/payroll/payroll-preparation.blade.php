                    ...
                    <div class="breadcrumb-line breadcrumb-line-dark header-elements-lg-inline">
                        <div class="d-flex">
                            <div class="breadcrumb">
                                ...
                                <span class="breadcrumb-item active">Payroll Preparation</span>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 offset-md-2">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="/payroll/payroll-preparation-post" method="post">
                                        {{@csrf_field()}}


                                        <fieldset>
                                            <legend class="font-weight-semibold">Payroll/Wages Preparation</legend>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control select-search" id="status" name="status" data-fouc required>
                                                            <option value="" selected disabled>--select--</option>
                                                            <option value="1">Regular Payroll</option>
                                            ...
                                            <div class="form-group row">
                                                <label class="col-lg-3 col-form-label">For the Month of</label>
                                                <div class="col-lg-9">
                                                    <div class="form-group">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="text-right">
                                                        <a href="/payroll/payroll-preparation-history" type="submit" class="btn btn-primary btn-light"><i class="icon-comment-discussion mr-1"></i>History</a>

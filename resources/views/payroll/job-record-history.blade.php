                                    ...
                                    <fieldset>
                                        ...
                                        <table class="table datatable-basic">
                                            ...
                                            <tbody>
                                                ...
                                                @foreach($job_record_extra as $count=>$item)
                                                <tr>
                                                    <td>{{$count+1}}</td>
                                                    <td>
                                                        @foreach($hr as $data)
                                                    ...
                                                    <td>{{$item->absent}}</td>
                                                    <td>{{$item->work_day}}</td>
                                                    <td>{{$item->other_benifit}} TK.</td>
                                                    <td>{{$item->other_deduction}} TK.</td>
                                                        ...
                                                        <div class="list-icons">
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    ...
                                                                    <a href="/payroll/job-record-history/delete/{{$item->id}}" class="dropdown-item"><i class="icon-trash"></i>Delete</a>

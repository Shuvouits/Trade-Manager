...
<head>
    ...
    <title>Chart of Accounts | Transaction Mode </title>
    @include('link')
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9">
                                                    <select class="form-control select" name="voucher_type" data-fouc required>
                                                        <option value="" selected disabled>--select--</option>
                                                        <option value="0">Receive Voucher</option>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="text-left">
                                                        <a href="/chart-account/transaction-mode-edit" class="btn btn-primary btn-light"><i class="icon-comment-discussion mr-1"></i>Edit</a>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="text-right">
                                                        <a href="/chart-account/transaction-mode-view" class="btn btn-primary btn-light"><i class="icon-comment-discussion mr-1"></i>View</a>

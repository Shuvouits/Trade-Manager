...
<head>
    ...
    <title>Chart of Accounts | Parent-Account</title>
    @include('link')
                    ...
                    <div class="breadcrumb-line breadcrumb-line-dark header-elements-lg-inline">
                        <div class="d-flex">
                            <div class="breadcrumb">
                                ...
                                <span class="breadcrumb-item active">Parent Account</span>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 offset-md-2">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="/chart-account/parent-account" method="post">
                                        {{@csrf_field()}}


                                        <fieldset>
                                            <legend class="font-weight-semibold">Chart of Account List/Parent Account</legend>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="name" class="form-control" placeholder="Enter your account" required>
